...
// Scenario 2b: market order walks multiple price levels — exercises findBest + level erasure on each step
// 10 sell levels at prices 101-110, 50 qty each; one market buy for 500 drains the entire book
